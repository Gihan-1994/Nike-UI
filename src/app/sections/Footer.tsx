...
import {socialMedia,footerLinks} from "@/app/constants";
                ...
                <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap">
                    {footerLinks.map((section,sectionID) => (
                        <div key={sectionID}>
                            ...
                            leadin-normal mb-6">{section.title}</h4>
                        <ul>
                            {section.links.map((link)=>(
                                <li className="mt-3 text-white-400
                                font-montserrat text-base leading-normal hover:text-slate-gray curser-pointer"
                                key={link.name}>
